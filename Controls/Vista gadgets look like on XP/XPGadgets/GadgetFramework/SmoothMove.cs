namespace GadgetFramework
{
    ...
    public class SmoothMove : ContentControl
    {
        ...
        public SmoothMove()
        {
            ...
            this.animateX = new DoubleAnimation(0, new Duration(TimeSpan.FromSeconds(.3)));
            ...
            this.animateY = new DoubleAnimation(0, new Duration(TimeSpan.FromSeconds(.3)));
