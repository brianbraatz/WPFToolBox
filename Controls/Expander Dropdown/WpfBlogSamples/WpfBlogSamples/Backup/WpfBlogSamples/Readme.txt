Avalon Web Browser Application Readme
----------------------------------
Web Browser Applications run in a sandbox with "Internet Permissions".
Only those Avalon features that have been successfully security reviewed and validated as safe by the Avalon team will run inside the sandbox.
