...
namespace Microsoft.Samples.KMoore.WPFSamples.Transition
{
    public class RotateTransition : Transition3D
    {
        ...
        private ModelVisual3D MakeSide(TransitionPresenter transitionElement, ContentPresenter content, Point3D origin, Vector3D u, Vector3D v, double endAngle, Point3D rotationCenter, Vector3D rotationAxis, EventHandler onCompleted)
        {
            Size size = transitionElement.RenderSize;
