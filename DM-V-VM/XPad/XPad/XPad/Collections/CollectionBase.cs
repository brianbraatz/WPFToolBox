...
namespace XPad
{
    ...
    public partial class CollectionBase<T> : ICollection<T>, ICollection, IList<T>, ICollectionBase<T> 
    {
        #region Events
        /// <summary>
        ...
        public virtual void CopyTo(T[] array, int arrayIndex)
        {
            ...
            if (count < 0)
                throw new ArgumentOutOfRangeException("count", count, "Argument out of range");
            if (arrayIndex < 0)
                throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, "Argument out of range");
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            if (index >= array.Length || count > array.Length - index)
                throw new ArgumentException("index", "Array too small");
