...
if(this.brLanguage)
{if(this.brLanguage.indexOf("en")<0)
{acbMinWdth=200;}}
this.acbEvtH=false;}
...
{ifrm.contentDocument.write(str);ifrm.contentDocument.onload=verifyDapResize(idx);}
...
if(doc)
{_dapdownlevel=false;doc.open("text/html","replace");doc.write(this.getDapOutput(rs+adCont[idx].qs,dapIfs,idx));}}
if(_dapdownlevel)
