...
// Iterate through the survey configurations.
        ...
        SiteRecruit_Config.invitations[0].acceptParams = 'l=9&site=69';
        SiteRecruit_Config.invitations[0].viewParams = 'log=comscore/view/p15808382-view.log&site=69';
        SiteRecruit_Config.invitations[0].invitationContent = '<table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td style="padding: 3px;"> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td style="padding: 1px;"> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/library/svy/msdn-logo-stripe.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/library/svy/msdn-close.gif" /></a><br /> <img src="/library/svy/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin-left: 10px; margin-right: 10px; margin-top: 10px; margin-bottom: 10px;">Microsoft is conducting an online survey to understand use of MSDN Online.  We’d like to see which pages you visit today and then have you complete a survey when you leave MSDN Online.<br /><br />Would you like to participate? </div>  <div align="center" style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin-bottom:15px;"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin-top: 0px; margin-bottom: 15px; margin-left: 10px;"><a style="color:#0000EE; text-decoration: underline; " href="http://www.microsoft.com/info/privacy.mspx" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/library/svy/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
        ...
        SiteRecruit_Config.invitations[0].autoCentering = true;
                    ...
                    SiteRecruit_Config.invitations[0].trackerUrl = '/library/svy/SiteRecruit_Tracker_p15808382mt.htm';
        ...
        SiteRecruit_Config.invitations[1].acceptParams = 'l=9&mth=1&site=69';
        SiteRecruit_Config.invitations[1].viewParams = 'log=comscore/view/p15466742-view.log&site=69';
        SiteRecruit_Config.invitations[1].invitationContent = '<table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td style="padding: 3px;"> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td style="padding: 1px;"> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/library/svy/msdn-logo-stripe.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/library/svy/msdn-close.gif" /></a><br /> <img src="/library/svy/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin-left: 10px; margin-right: 10px; margin-top: 10px; margin-bottom: 10px;">Microsoft is conducting an online survey to understand use of the Microsoft.com Web site. We\'d like to see which pages you visit today and then have you complete a survey when you leave the Microsoft.com Web site. Would you like to participate? </div>  <div align="center" style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin-bottom:15px;"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin-top: 0px; margin-bottom: 15px; margin-left: 10px;"><a style="color:#0000EE; text-decoration: underline; " href="http://privacy.microsoft.com/en-us/default.aspx" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/library/svy/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
