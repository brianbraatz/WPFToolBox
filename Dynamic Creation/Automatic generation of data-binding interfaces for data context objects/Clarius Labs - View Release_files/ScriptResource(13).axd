...
targetRect = CommonToolkitScripts.getBounds(this._dropTargets[i].get_dropTargetElement());if (Sys.UI.Control.overlaps(cursorRect, targetRect) && this._dropTargets[i].canDrop(mode, type, data)) {
...
var newOffset = CommonToolkitScripts.getLocation(this._activeDragVisual);if (this._oldOffset.x != newOffset.x || this._oldOffset.y != newOffset.y) {
this._activeDragVisual.startingPoint = this.subtractPoints(this._activeDragVisual.startingPoint, this.subtractPoints(this._oldOffset, newOffset));scrollOffset = this.getScrollOffset(this._activeDragVisual,  true);var position = this.addPoints(this.subtractPoints(document._lastPosition, this._activeDragVisual.startingPoint), scrollOffset);CommonToolkitScripts.setLocation(this._activeDragVisual, position);}
},
...
var oldLeft = document.body.scrollLeft;var oldTop = document.body.scrollTop;window.scrollBy(this._scrollDeltaX, this._scrollDeltaY);var newLeft = document.body.scrollLeft;var newTop = document.body.scrollTop;var dragVisual = this._activeDragVisual;var position = { x: parseInt(dragVisual.style.left) + (newLeft - oldLeft), y: parseInt(dragVisual.style.top) + (newTop - oldTop) };CommonToolkitScripts.setLocation(dragVisual, position);}
}
