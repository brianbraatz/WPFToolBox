//Tag Version: Codeplex 1.0/04-05-06
...
function dcsDownload(evt){
	...
	if (evt){
		...
		if (e.hostname){
			...
			dcsMultiTrack("DCS.dcssip",e.hostname,"DCS.dcsuri",path,"DCS.dcsqry",e.search||"","WT.ti","Link:"+(e.innerHTML||""),"WT.dl","1","WT.ad","","WT.mc_id","","WT.sp","");
...
function dcsFormButton(evt){
	...
	if (evt){
		...
		if (type&&((type=="submit")||(type=="image")||(type=="button")||(type=="reset"))||((type=="text")&&((evt.which||evt.keyCode)==13))){
			...
			dcsMultiTrack("DCS.dcsuri",e.form.action,"DCS.dcsqry",qry,"WT.ti","FormButton:"+title,"WT.dl","2","WT.ad","","WT.mc_id","","WT.sp","");
