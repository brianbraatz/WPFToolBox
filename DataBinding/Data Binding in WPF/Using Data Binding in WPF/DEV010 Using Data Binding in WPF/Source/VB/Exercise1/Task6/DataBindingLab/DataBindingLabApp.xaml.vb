...
Partial Public Class DataBindingLabApp
    ...
    Private Sub LoadAuctionData()
        ...
        Dim theIncredibles As AuctionItem = New AuctionItem("The Incredibles (DVD)", ProductCategory.DVDs, 5, New DateTime(2005, 8, 3), userMary, SpecialFeatures.Highlight)
        theIncredibles.AddBid(New Bid(6, userMike))
        theIncredibles.AddBid(New Bid(8, Me.CurrentUser))

        Dim futurama As AuctionItem = New AuctionItem("Futurama (all episodes)", ProductCategory.DVDs, 40, New DateTime(2005, 7, 28), userAnna, SpecialFeatures.None)
        futurama.AddBid(New Bid(42, userMike))
        futurama.AddBid(New Bid(45, userMark))
        futurama.AddBid(New Bid(50, userMike))
        futurama.AddBid(New Bid(51, Me.CurrentUser))
        ...
        Me.AuctionItems.Add(theIncredibles)
        Me.AuctionItems.Add(futurama)
