...
namespace DataBindingLab
{
    ...
    {        
        ...
        private void LoadAuctionData()
        {
            ...
            AuctionItem theIncredibles = new AuctionItem("The Incredibles (DVD)", ProductCategory.DVDs, 5, new DateTime(2005, 8, 3), userMary, SpecialFeatures.Highlight);
            theIncredibles.AddBid(new Bid(6, userMike));
            theIncredibles.AddBid(new Bid(8, this.currentUser));

            AuctionItem futurama = new AuctionItem("Futurama (all episodes)", ProductCategory.DVDs, 40, new DateTime(2005, 7, 28), userAnna, SpecialFeatures.None);
            futurama.AddBid(new Bid(42, userMike));
            futurama.AddBid(new Bid(45, userMark));
            futurama.AddBid(new Bid(50, userMike));
            futurama.AddBid(new Bid(51, this.currentUser));
            ...
            this.AuctionItems.Add(theIncredibles);
            this.AuctionItems.Add(futurama);
