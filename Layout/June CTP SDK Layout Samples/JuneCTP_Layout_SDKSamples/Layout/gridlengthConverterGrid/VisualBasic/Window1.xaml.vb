...
namespace GridLengthConverter_grid
    ...
    Partial Public Class Window1
        ...
        Public Sub changeRowVal(ByVal sender As Object, ByVal args As RoutedPropertyChangedEventArgs(Of Double))

            txt2.Text = "Current Grid Row is " + hs2.Value.ToString()
        End Sub

        ' <Snippet1>
        Public Sub changeColVal(ByVal sender As Object, ByVal args As RoutedPropertyChangedEventArgs(Of Double))

            txt1.Text = "Current Grid Column is " + hs1.Value.ToString()
        End Sub

        Public Sub changeCol(ByVal sender As Object, ByVal args As SelectionChangedEventArgs)
        ...
        End Sub
        ' </Snippet1>
        Public Sub changeRow(ByVal sender As Object, ByVal args As SelectionChangedEventArgs)
        ...
        Public Sub setMinWidth(ByVal sender As Object, ByVal args As RoutedEventArgs)

            col1.MinWidth = 100
            col2.MinWidth = 100
            col3.MinWidth = 100
        End Sub
        Public Sub setMaxWidth(ByVal sender As Object, ByVal args As RoutedEventArgs)

            col1.MaxWidth = 125
            col2.MaxWidth = 125
            col3.MaxWidth = 125
        End Sub
        Public Sub setMinHeight(ByVal sender As Object, ByVal args As RoutedEventArgs)

            row1.MinHeight = 50
            row2.MinHeight = 50
            row3.MinHeight = 50
        End Sub
        Public Sub setMaxHeight(ByVal sender As Object, ByVal args As RoutedEventArgs)
