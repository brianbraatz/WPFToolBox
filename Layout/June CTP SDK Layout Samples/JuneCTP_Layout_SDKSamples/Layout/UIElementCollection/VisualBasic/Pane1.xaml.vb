...
Namespace ElemCollMethodsVB
    ...
    Partial Class Pane1
        ...
        ' <Snippet3>
        Sub AddButton(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            sp1.Children.Clear()
            btn = New Button()
        ...
        Sub InsertButton(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            sp1.Children.Clear()
            btn = New Button()
        ...
        ' <Snippet4>
        Sub InsertControls(ByVal sender As Object, ByVal e As RoutedEventArgs)
            btn2 = New Button()
            btn2.Content = "Inserted Button"
            sp1.Children.Insert(1, btn2)
        End Sub
        ' </Snippet4>
        Sub ShowIndex(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
            sp1.Children.Clear()
            btn = New Button()
        ...
        Sub PrintIndex(ByVal sender As Object, ByVal e As RoutedEventArgs)
            btn.Content = ((sp1.Children.IndexOf(btn)).ToString())
        End Sub
        Sub PrintIndex1(ByVal sender As Object, ByVal e As RoutedEventArgs)
            btn1.Content = ((sp1.Children.IndexOf(btn1)).ToString())
        End Sub
        Sub PrintIndex2(ByVal sender As Object, ByVal e As RoutedEventArgs)
            btn2.Content = ((sp1.Children.IndexOf(btn2)).ToString())
        End Sub
        Sub PrintIndex3(ByVal sender As Object, ByVal e As RoutedEventArgs)
