...
Namespace ThicknessConverter
    ...
    Partial Public Class Window1
        ...
        ' <Snippet1>
        Public Sub changeThickness(ByVal sender As Object, ByVal args As SelectionChangedEventArgs)
        ...
        Public Sub changeColor(ByVal sender As Object, ByVal args As SelectionChangedEventArgs)
