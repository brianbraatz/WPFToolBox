...
SiteRecruit_Config.frequency = 0.0025;
...
// Iterate through the survey configurations.
        ...
        SiteRecruit_Config.invitations[0].weight = 97;
        SiteRecruit_Config.invitations[0].projectId = 'p15808382mt';
        SiteRecruit_Config.invitations[0].invitationType = 2;
        SiteRecruit_Config.invitations[0].acceptUrl = 'http://survey2.surveysite.com/wix/p15808382.aspx';
        SiteRecruit_Config.invitations[0].viewUrl = 'http://web.survey-poll.com/tc/CreateLog.aspx';
        SiteRecruit_Config.invitations[0].acceptParams = 'l=9&site=72';
        SiteRecruit_Config.invitations[0].viewParams = 'log=comscore/view/p15808382-view.log&site=72';
        SiteRecruit_Config.invitations[0].invitationContent = '<table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/msdn-logo-stripe.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/msdn-close.gif" /></a><br /> <img src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 0 0 15px 0;">Microsoft is conducting an online survey to understand use of MSDN Online.  We’d like to see which pages you visit today and then have you complete a survey when you leave MSDN Online.<br /><br />Would you like to participate? </div>  <div align="center" style="margin: 0; padding: 0"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 15px 0 2px 0;"><a style="color:#0000EE; text-decoration: underline; " href="http://www.microsoft.com/info/privacy.mspx" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
        ...
        SiteRecruit_Config.invitations[0].autoCentering = true;
                    ...
                    SiteRecruit_Config.invitations[0].trackerUrl = '/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/SiteRecruit_Tracker_p15808382mt.htm';
        ...
        SiteRecruit_Config.invitations[1].weight = 3;
        SiteRecruit_Config.invitations[1].projectId = 'p15466742';
        SiteRecruit_Config.invitations[1].invitationType = 2;
        SiteRecruit_Config.invitations[1].acceptUrl = 'http://survey2.surveysite.com/wix/p15466742.aspx';
        SiteRecruit_Config.invitations[1].viewUrl = 'http://web.survey-poll.com/tc/CreateLog.aspx';
        SiteRecruit_Config.invitations[1].acceptParams = 'l=9&mth=1&site=72';
        SiteRecruit_Config.invitations[1].viewParams = 'log=comscore/view/p15466742-view.log&site=72';
        SiteRecruit_Config.invitations[1].invitationContent = '<table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/msdn-logo-stripe.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/msdn-close.gif" /></a><br /> <img src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 0 0 15px 0;">Microsoft is conducting an online survey to understand use of the Microsoft.com Web site. We\'d like to see which pages you visit today and then have you complete a survey when you leave the Microsoft.com Web site. Would you like to participate? </div>  <div align="center" style="margin: 0; padding: 0"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 15px 0 2px 0;"><a href="http://privacy.microsoft.com/en-us/default.aspx" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
        ...
        SiteRecruit_Config.invitations[1].autoCentering = true;
                    ...
                    SiteRecruit_Config.invitations[1].trackerUrl = '/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/SiteRecruit_Tracker_3332mt.htm';
            
            //(features, width, height, orientation, offsetX, offsetY)
            SiteRecruit_Config.invitations[1].trackerWindowConfig = { "width":400,
																		"height":270,
																		"orientation":'Center',
																		"offsetX":0,
																		"offsetY":0,
...
if (SiteRecruit_Globals.isInternetExplorer || SiteRecruit_Globals.isMozilla)
{
    ...
    {  
        SiteRecruit_Globals.startBuilder = true;
                    ...
                    var uniqueUrl = '/msdn/Controls/MTPS_SurveyLauncherCtrl/en-us/SiteRecruit_InvitationBuilder.js?' + (new Date()).getTime();
