...
function selectCode(id) 
{
	if (id == "vb")
	{
		document.getElementById('chash').style.display = 'none';
	...
	if (id == "chash")
	{
		...
		document.getElementById('chash').style.display = 'block';
	}
	
	if (id == "vbSearch")
	{
		document.getElementById('chashSearch').style.display = 'none';
		document.getElementById('vbSearch').style.display = 'block';
	}
	
	if (id == "chashSearch")
	{
		document.getElementById('vbSearch').style.display = 'none';
		document.getElementById('chashSearch').style.display = 'block';
	}
}
