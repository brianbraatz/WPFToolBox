...
Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditorBehavior = function(element) {

    Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditorBehavior.initializeBase(this, [element]);
...
Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditorBehavior.prototype = {

    initialize : function() {
        Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditorBehavior.callBaseMethod(this, 'initialize');
        
        this._component = $create( Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditor,
    ...
    dispose : function() {
        ...
        Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditorBehavior.callBaseMethod(this, 'dispose');
    },
...
Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditorBehavior.registerClass('Microsoft.Mtps.Rendering.Behaviors.Ajax.InlineEditorBehavior', Microsoft.Mtps.Rendering.Behaviors.Ajax.BehaviorBase);
