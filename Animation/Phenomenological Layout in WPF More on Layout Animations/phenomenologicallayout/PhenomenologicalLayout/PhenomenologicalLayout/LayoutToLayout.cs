...
namespace LayoutToLayout
{
    ...
    public class LayoutToLayoutHost : Border
    {
        ...
        /*
         * Link up the Host to the Target 
         * */
         ...
         * */
        public void SetUpAnimation(bool Disappear)
        {
            if (Animating == true)
            {
                EndAnimations();
        ...
        public void UpdateFromTarget()
        {
            ...
            if (AnimateChanges)
                AnimateFromTarget();
            //there is some weirdness here that needs to be figured out
            //else
              //  MatchLayout();
        ...
        private void MatchLayout()
        {
            ...
            Point pt = Target.TranslatePoint(new Point(0, 0), Parent as UIElement);
