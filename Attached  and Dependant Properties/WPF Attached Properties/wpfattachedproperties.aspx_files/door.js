...
gSN=new Array('<b>','<h1>','<h2>','<h3>','<h4>','<h5>','<strong>','<em>','<i>','!footer');
...
t_s='20071024200328';
mk=7;
server='windows-now.us.intellitxt.com';
cc='us';
rcc='us';
itxtreg='ca';
itxtdma='807';
...
gFdBck='';
gSI=1;
gSID='05d61021e21f0fe1a85cbb5e8e90fc08';
gMiFo=0;
mTL=50;
gDrag=1;
gMSNsb=-1;
...
gHLN=1;
gKWPF=0;
gPVU='f1661052818d44ec8206c63925684e3a';
gPVM='36fec13f2cc6ec0191bd1eb7c71db5ee';
gIPL=0;
iTTC=0;
gCSc='';
...
iNBc=0,
iADi=0,
sRU='http://www.windows-now.com/blogs/rrelyea/archive/2006/02/09/wpfattachedproperties.aspx',
gMR=1000,
bWAC=0,
bYCR=0,
gMNC=255,
...
itxtInited=1;
itxtLES('http://images.intellitxt.com/ast/js/vm/func_200710161248.js');
}
